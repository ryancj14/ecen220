...
HD_PWD='J:/ECEN 220 Labs/Lab4-Arithmetic/Lab4-Arithmetic/Lab4-Arithmetic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Add9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Add9.tcl
